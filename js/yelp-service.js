...
class YelpService {
    ...
    async searchRestaurants(latitude, longitude, radius = 5000, limit = 50) {
        try {
            ...
            // Backend deployed on Railway - Production URL
            const backendUrl = `https://fastfoodz-production.up.railway.app/api/restaurants?lat=${latitude}&lng=${longitude}&radius=${radius}&limit=${limit}`;
